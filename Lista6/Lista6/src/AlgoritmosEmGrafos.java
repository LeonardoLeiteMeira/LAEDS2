...
public class AlgoritmosEmGrafos {
     private final int[] distanciaProfundidade; //guarda a distancia, em vertices, entre o no inicial da busca em profundidade e cada um dos outros vertices do grafo
    private final int[] verticePredecessor; //armazena o vertice predecessor de cada no descoberto durante a busca em produndidade
    private Grafo grafo;
    private int inicial;
    
    public AlgoritmosEmGrafos(Grafo grafo) { // metodo construtor, define os valores iniciais dos vetores
